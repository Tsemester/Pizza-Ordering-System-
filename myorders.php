...
$query_res= mysqli_query($conn,"select * from tbl_order where username='".$_SESSION['user_id']."'");
...
?>
<tr>	
<td data-column="Item"> <?php echo $row['food']; ?></td>
<td data-column="Quantity"> <?php echo $row['qty']; ?></td>
<td data-column="price"><?php echo $row['price']; ?></td>
<td data-column="status"> 
<?php 
$status=$row['status'];
		if($status=="Ordered" or $status=="NULL")
		{
		?>
    ...
    <td data-column="Action"> <a href="delete_orders.php?order_del=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
